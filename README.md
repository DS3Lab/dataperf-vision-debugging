...
For a detailed summary of the a benchmark, refer to the provided [benchmark documentation](https://www.notion.so/xzyaoi/DataPerf-Data-Cleaning-Challenge-23b7296eb8fb46aea5c396120a978ed3).

A design document for the benchmark can be found [here](https://docs.google.com/document/d/1J8poMyW63rAmb1Rq4Ni6iAgryCcijqIGtM7cGb3cyB8/edit). Note that permission is required to view the benchmark design doc. Please join MLCommons/DataPerf Workgroup to request access or send an email to [xiaozhe.yao@inf.ethz.ch](mailto:xiaozhe.yao@inf.ethz.ch)
